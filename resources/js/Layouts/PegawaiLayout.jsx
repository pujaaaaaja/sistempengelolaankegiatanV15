...
export default function PegawaiLayout({ header, children }) {
    // Menggunakan usePage() hook untuk mendapatkan data 'auth' yang dibagikan secara global
    const { auth } = usePage().props;
    const user = auth.user; // Mendapatkan detail user dari prop 'auth'
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            {/* Link Navigasi Utama untuk Pegawai */}
